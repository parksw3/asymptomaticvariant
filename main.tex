...
\begin{flushleft}{
	\Large
	\textbf\newline{
		Intermediate levels of asymptomatic transmission lead to the highest levels of fatalities \swp{89/96 characters}
	}
}
\newline
\\
...
Asymptomatic transmission and fatalities \swp{40/40 characters}

\section*{One-sentence summary}

Asymptomatic infections improve individual-level outcomes but increase overall transmission, thereby causing more deaths. \swp{121/125 characters}
