...
The relative transmission rate of asymptomatically infected individuals was not well constrained, but relatively low transmissibility (e.g., between 0\%-25\%) by asymptomatic individuals was ruled out because it required unrealistically high transmissibility for symptomatically infected individuals (\fref{evidence}B).
...
However, asymptomatically infected individuals, especially among younger individuals with high contact rates, can still transmit to other, older individuals, potentially making the population-level outcomes worse than they would be if intervention measures were distributed differently.
