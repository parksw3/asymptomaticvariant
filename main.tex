...
in this case, total infections and fatalities are maximized when all transmission is caused by pre-symptomatic transmission. \jd{What?? If all transmission is pre-symptomatic, then we get no fatalities in our model.} \swp{what do you mean? if all non-symptomatic transmission is caused by pre-symptomatic transmission, then everyone eventually develops symptoms...}
