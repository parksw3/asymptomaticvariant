...
(B) Previous estimates of the ratio $\theta_a$ of the transmisson rates between asymptomatic and symptomatic individuals from the Diamond Princess Cruise Ship.
Symptomatic individuals were assumed to transmit at rate $\beta(t)$ for an averae of 2.9 days, followed by a presymptomatic stage with an average of 2.1 days. 
Aymptomatic individuals were assumed to transmit at rate $\theta_a \beta(t)$ for an averae of 5 days.
...
We now consider each protection scenarios separately.
