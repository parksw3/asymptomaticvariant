...
High values of $\delta$ may seem unrealistic---in practice, $\delta$ cannot be greater than the amouont of post-symptomatic transmission.
While several studies have estimated the proportion of pre-symptomatic transmission to be around 30\%--60\% for the SARS-CoV-2 wildtype strain, many of them were likely subject to 

mitigation steps took place and before awareness of the
epidemic became widespread

\citep{he2020temporal}.

\cite{sender2021unmitigated} recently showed the proportion of pre-symptomatic transmission is likely lower than previously estimated 

can be as low as 20\% (95\%CI: 6\%--32\%) in the absence of intervention measures, providing indirect support for the plausibility of high $\delta$ values.
