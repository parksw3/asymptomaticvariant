...
While 60\% reduction in transmission after symptom onset ($\delta_s = 0.6$) is still high, it does not seem unrealistic.
...
In contrast, the Diamond Princess data provide a unique perspective on the relative transmissibility from immunologically naive asymptomatic individuals.''
